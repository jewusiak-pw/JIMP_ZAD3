...
int main(int argc, char *argv[]) {
    ...
    FILE *we = argc > 1 ? fopen(argv[1], "r") : stdin;    /* jesli argc > 1 to* program zostal
...
//PRACA NA OBU
    ...
    switch(CzyOrtagonalne(w_1, w_2, n1, n2)){
        case 0:
            printf("nieortagonalne.\n");
            break;
        case 1:
            printf("ortagonalne.\n");
            break;
